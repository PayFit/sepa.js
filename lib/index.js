...
class SepaPaymentInfo {
  ...
  toXML(document) {
    ...
    const validId = this.id.slice(0, 35); // respects IFX norm: https://schemas.liquid-technologies.com/IFX/1.7/?page=max35text.html
    requiredNode(document, pmtInf, 'PmtInfId', validId);
