...
(function(exports) {
  ...
  SepaPaymentInfo.prototype = {
    ...
    toXML: function(doc) {
      ...
      r(pmtTpInf, 'CtgyPurp', 'Cd', this[pullFrom + 'CategoryPurpose']);
      ...
      if (this[pullFrom + 'BIC']) {
        ...
        r(finInstnId, 'PstlAdr', 'Ctry', this[pullFrom + 'Country']);
      } else {
  ...
  SepaTransaction.prototype = {
    ...
    toXML: function(doc) {
      ...
      if (this[pullFrom + 'BIC']) {
        var finInstnId = n(pmtInf, recieverNodeName + 'Agt', 'FinInstnId');
        r(finInstnId, 'BIC', this[pullFrom + 'BIC']);
        r(finInstnId, 'PstlAdr', 'Ctry', this[pullFrom + 'Country']);
      } else {
